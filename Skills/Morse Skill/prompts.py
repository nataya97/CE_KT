...
GET_STORY = ["Morse code is a method used in telecommunication to encode text characters as standardited sequences.",
             ...
             "The international Morse Code encodes the 26 English letters A through Z, some non-English letters, the Arabic numerals and a small set of punctuation and procedural signals.",
